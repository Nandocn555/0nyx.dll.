...
def ip_info(ip_address):
    ...
    if response.status_code == 200:
        ...
        if data['status'] == 'success':
            ...
            print("\033[32mCheck the IP address and try again.\033[0m")
    else:
        print("\033[32mPlease try again later **(API)**.\033[0m")
...
def ping_ip(ip_address):
    ...
    try:
        ...
        print("\033[32mThe ping has expired (Timeout).\033[0m")
    except Exception as e:
        print(f"\033[32mAn error has occurred: {e}\033[0m")
...
def port_scan(ip_address):
    open_ports = []
    print(f"\033[32mScanning ports on {ip_address}... This may take a while.\033[0m")
    ...
    if open_ports:
        ...
        print(f"\033[32mOpen ports: {open_ports}\033[0m")
    else:
        print(f"\033[32mNo open ports found on {ip_address}.\033[0m")
...
def reverse_dns(ip_address):
    try:
        ...
        print("\033[32mThe command 'nslookup' was not found.\033[0m")
    except Exception as e:
        print(f"\033[32mAn error has ocurred: {e}\033[0m")
    ...
    while True:
        ...
        try:
            ...
            if choice == 0:
                ...
                ip_address = input("\033[32mIP Adress >> \033[0m")
                os.system('cls' if os.name == 'nt' else 'clear')
                print(f"\033[32m{menu}\033[0m")
                ip_info(ip_address)
            elif choice == 2:
