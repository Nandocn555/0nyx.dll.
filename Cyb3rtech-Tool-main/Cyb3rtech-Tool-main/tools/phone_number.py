...
def track_phone_number(phone_number):
    ...
    try:
        ...
        if not phonenumbers.is_valid_number(parsed_number):
            print("\033[32m[!] Invalid phone number format [!]\033[0m")
            return
        ...
        print(f"\033[32mSearching dates of number '+{phone_number}'..\n\033[0m")
        time.sleep(2)
        for key, value in number_info.items():
            print(f"\033[32m{key}: {value}\033[0m")
    
    except phonenumbers.NumberParseException:
        print("\033[32m[!] Failed to parse phone number [!]\033[0m")
    ...
    while True:
        ...
        try:
            ...
            if choice == 0:
                ...
                phone_number = input('\033[32mPhone Number >> \033[0m')
                os.system('cls' if os.name == 'nt' else 'clear')
                print(f"\033[32m{menu}\033[0m")
